	...
	<div class="container">
		...
		<div class="contact-details-grid">
			...
			<div class="contact-item">
				<a href="mailto:{contactInfo.email}" class="icon-link">
					<svg
						class="contact-icon"
			...
			<!-- Phone Contact -->
			<div class="contact-item">
				<a href="tel:{contactInfo.phone.replace(/\s/g, '')}" class="icon-link">
					...
					>
						<path
							d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24c1.12.37 2.33.57 3.57.57c.55 0 1 .45 1 1v3.5c0 .55-.45 1-1 1C12.43 23 2 12.57 2 6c0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1c0 1.24.2 2.45.57 3.57c.12.35.03.75-.25 1.02l-2.2 2.2z"
						/>
					</svg>
			...
			{#each socialLinks as link (link.name)}
				...
				>
					<svg
						...
						width="48"
						height="48"
						{...link.iconViewBox && { viewBox: link.iconViewBox }}
						fill="currentColor"
					>
